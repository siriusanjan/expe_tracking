...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, constraints) {
      ...
      if (AppValues.mainScreenWidth == -1 || AppValues.mainScreenWidth < 5) {
        AppValues.mainScreenWidth = screenWidth;
        AppValues.mainScreenHeight = screenHeight;
        AppValues.appCommonHorizontalPadding = screenWidth * 0.04;
      }
